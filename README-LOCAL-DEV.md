...
2. **Configure Bot Token Scopes** (OAuth & Permissions)
   ...
   - Add these 5 scopes (click "Add an OAuth Scope" for each):
     ...
     - `reactions:write` - To add 👀 for instant feedback when processing
...
- ✅ Added all 5 required bot scopes (see step 2 in Slack App Configuration)
